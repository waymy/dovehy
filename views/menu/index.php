...
function deleterow(obj){
	...
	function editMenu(id){
		AjaxPost('<?=Url::to(['menu/edit-menu'])?>' + '?id=' + id,'empty','empty',function(data){
	...
	function saveMenu(obj){
		AjaxPost('<?=Url::to(['menu/edit-menu','act'=>'save'])?>','editForm',obj ? obj : '#SaveMenubtn',function(d){
			if(d.result){
				$('#editMenu').modal('hide');
			}
		});
...
function submitForm(obj){
  AjaxPost('<?=Url::to(['menu/deal-menu'])?>','form',obj ? obj : '#SaveEventbtn');
  return false;
}
